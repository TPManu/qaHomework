...
let employees: Array<Employees> = [
  ...
  new Employees("Jerry Smith", 5474832984, "Father"),
  new Employees("Beth Smith", 2342431456, "Mother"),
  new Employees("Summer Smtih", 8750342930, "Sister"),
  new Employees("Morty Smtih",9875648397, "Brother"),
]
